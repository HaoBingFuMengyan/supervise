...
/**会员店铺信息**/
//public static final String hy_membershop="hy_membershop" ;
public static class hy_membershop {
public static XSpec<com.frogsing.member.po.MemberShop> xspec() {
    return new XSpec<com.frogsing.member.po.MemberShop>(com.frogsing.member.po.MemberShop.class);
    }
    public static final String tablename="hy_membershop";
            /**会员ID**/
            public static final String smemberid="smemberid" ;
            /**店铺名称**/
            public static final String sshopname="sshopname" ;
            /**店铺Logo**/
            public static final String slogo="slogo" ;
            /**banner**/
            public static final String sbannerurl="sbannerurl" ;
            /**QQ**/
            public static final String sqq="sqq" ;
            /**微信**/
            ...
            /**域名**/
            public static final String sdomain="sdomain" ;
            /**开通时间**/
            ...
            public static final String istatus="istatus" ;
            /**审核意见**/
            public static final String scheckmark="scheckmark" ;
            /**版本号**/
            public static final String iversion="iversion" ;
            /**主营**/
            public static final String sbusiness="sbusiness" ;
            /**区域**/
            public static final String sregion="sregion" ;
            /**成功案例**/
            public static final String ssuccessexam="ssuccessexam" ;
            /**公司介绍**/
            public static final String scompanydesc="scompanydesc" ;
            /**会员ID**/
            public static  Path<String> smemberid(Root<?> root){return root.get("smemberid");}
            /**店铺名称**/
            public static  Path<String> sshopname(Root<?> root){return root.get("sshopname");}
            /**店铺Logo**/
            public static  Path<String> slogo(Root<?> root){return root.get("slogo");}
            /**banner**/
            public static  Path<String> sbannerurl(Root<?> root){return root.get("sbannerurl");}
            /**QQ**/
            public static  Path<String> sqq(Root<?> root){return root.get("sqq");}
            /**微信**/
            public static  Path<String> swx(Root<?> root){return root.get("swx");}
            /**手机号**/
            public static  Path<String> slinkmobile(Root<?> root){return root.get("slinkmobile");}
            /**描述**/
            public static  Path<String> sdesc(Root<?> root){return root.get("sdesc");}
            /**联系人**/
            public static  Path<String> slinkname(Root<?> root){return root.get("slinkname");}
            /**域名**/
            public static  Path<String> sdomain(Root<?> root){return root.get("sdomain");}
            /**开通时间**/
            public static  Path<Date> dopendate(Root<?> root){return root.get("dopendate");}
            /**申请时间**/
            public static  Path<Date> dapplydate(Root<?> root){return root.get("dapplydate");}
            /**状态**/
            public static  Path<Integer> istatus(Root<?> root){return root.get("istatus");}
            /**审核意见**/
            public static  Path<String> scheckmark(Root<?> root){return root.get("scheckmark");}
            /**版本号**/
            public static  Path<Integer> iversion(Root<?> root){return root.get("iversion");}
            /**主营**/
            public static  Path<String> sbusiness(Root<?> root){return root.get("sbusiness");}
            /**区域**/
            public static  Path<String> sregion(Root<?> root){return root.get("sregion");}
            /**成功案例**/
            public static  Path<String> ssuccessexam(Root<?> root){return root.get("ssuccessexam");}
            /**公司介绍**/
            public static  Path<String> scompanydesc(Root<?> root){return root.get("scompanydesc");}

    }
/**会员开票资料表**/
//public static final String hy_invoiceinfo="hy_invoiceinfo" ;
public static class hy_invoiceinfo {
public static XSpec<com.frogsing.member.po.InvoiceInfo> xspec() {
    return new XSpec<com.frogsing.member.po.InvoiceInfo>(com.frogsing.member.po.InvoiceInfo.class);
    }
    public static final String tablename="hy_invoiceinfo";
            /**会员ID**/
            public static final String smemberid="smemberid" ;
            /**发票类型**/
            public static final String itype="itype" ;
            /**公司抬头**/
            public static final String scompanynmae="scompanynmae" ;
            /**纳税人识别码**/
            public static final String staxno="staxno" ;
            /**国家**/
            public static final String scountry="scountry" ;
            ...
            /**银行账号**/
            public static final String sbankaccount="sbankaccount" ;
            /**收票人姓名**/
            public static final String srecvname="srecvname" ;
            /**收票人电话**/
            public static final String srecvtel="srecvtel" ;
            /**收票地址**/
            public static final String srecvaddr="srecvaddr" ;
            /**添加人**/
            public static final String sadduserid="sadduserid" ;
            /**添加时间**/
            public static final String dadddate="dadddate" ;
            /**最后修改人**/
            public static final String smodifyuserid="smodifyuserid" ;
            /**会员ID**/
            public static  Path<String> smemberid(Root<?> root){return root.get("smemberid");}
            /**发票类型**/
            public static  Path<Integer> itype(Root<?> root){return root.get("itype");}
            /**公司抬头**/
            public static  Path<String> scompanynmae(Root<?> root){return root.get("scompanynmae");}
            /**纳税人识别码**/
            public static  Path<String> staxno(Root<?> root){return root.get("staxno");}
            /**国家**/
            public static  Path<String> scountry(Root<?> root){return root.get("scountry");}
            ...
            public static  Path<String> saddress(Root<?> root){return root.get("saddress");}
            /**注册电话**/
            public static  Path<String> stel(Root<?> root){return root.get("stel");}
            /**开户银行**/
            public static  Path<String> sbank(Root<?> root){return root.get("sbank");}
            /**银行账号**/
            public static  Path<String> sbankaccount(Root<?> root){return root.get("sbankaccount");}
            /**收票人姓名**/
            public static  Path<String> srecvname(Root<?> root){return root.get("srecvname");}
            /**收票人电话**/
            public static  Path<String> srecvtel(Root<?> root){return root.get("srecvtel");}
            /**收票地址**/
            public static  Path<String> srecvaddr(Root<?> root){return root.get("srecvaddr");}
            /**添加人**/
            public static  Path<String> sadduserid(Root<?> root){return root.get("sadduserid");}
            /**添加时间**/
            public static  Path<Date> dadddate(Root<?> root){return root.get("dadddate");}
            /**最后修改人**/
            public static  Path<String> smodifyuserid(Root<?> root){return root.get("smodifyuserid");}
...
/**收付款账号表**/
//public static final String hy_payaccount="hy_payaccount" ;
public static class hy_payaccount {
public static XSpec<com.frogsing.member.po.PayAccount> xspec() {
    return new XSpec<com.frogsing.member.po.PayAccount>(com.frogsing.member.po.PayAccount.class);
    }
    public static final String tablename="hy_payaccount";
            /**会员ID**/
            public static final String smemberid="smemberid" ;
            /**开户银行**/
            public static final String sbank="sbank" ;
...
/**店铺申请表**/
//public static final String hy_membershopapply="hy_membershopapply" ;
public static class hy_membershopapply {
public static XSpec<com.frogsing.member.po.MemberShopApply> xspec() {
    return new XSpec<com.frogsing.member.po.MemberShopApply>(com.frogsing.member.po.MemberShopApply.class);
    }
    public static final String tablename="hy_membershopapply";
            /**会员ID**/
            public static final String smemberid="smemberid" ;
            /**店铺名称**/
            public static final String sshopname="sshopname" ;
...
/**店铺产品关联表**/
//public static final String hy_relaresource="hy_relaresource" ;
public static class hy_relaresource {
public static XSpec<com.frogsing.member.po.RelaResource> xspec() {
    return new XSpec<com.frogsing.member.po.RelaResource>(com.frogsing.member.po.RelaResource.class);
    }
    public static final String tablename="hy_relaresource";
            /**会员ID**/
            public static final String smemberid="smemberid" ;
            /**店铺ID**/
            public static final String smembershopid="smembershopid" ;
            /**资源ID**/
            public static final String sresourceid="sresourceid" ;
            /**产品分类ID**/
            public static final String sproductid="sproductid" ;
            /**资源名称**/
            public static final String sresourcename="sresourcename" ;
            /**分类名称**/
            public static final String sname="sname" ;
            /**编号**/
            ...
            public static final String sremark="sremark" ;
            /**资源类型**/
            public static final String ispottype="ispottype" ;
            /**会员ID**/
            public static  Path<String> smemberid(Root<?> root){return root.get("smemberid");}
            /**店铺ID**/
            public static  Path<String> smembershopid(Root<?> root){return root.get("smembershopid");}
            /**资源ID**/
            public static  Path<String> sresourceid(Root<?> root){return root.get("sresourceid");}
            /**产品分类ID**/
            public static  Path<String> sproductid(Root<?> root){return root.get("sproductid");}
            /**资源名称**/
            public static  Path<String> sresourcename(Root<?> root){return root.get("sresourcename");}
            /**分类名称**/
            public static  Path<String> sname(Root<?> root){return root.get("sname");}
            /**编号**/
            ...
            public static  Path<String> sremark(Root<?> root){return root.get("sremark");}
            /**资源类型**/
            public static  Path<Integer> ispottype(Root<?> root){return root.get("ispottype");}
