...
import com.frogsing.heart.beanvalidator.BeanValidators;
import com.frogsing.heart.mapper.JsonMapper;
 ...
 * @version 2013-3-23
 */
public abstract class BaseController<T, V> implements IBaseController<T, V> {
    ...
    protected String renderString(HttpServletResponse response, Object object) {
        return renderString(response, new JsonMapper().toJson(object));
    }
