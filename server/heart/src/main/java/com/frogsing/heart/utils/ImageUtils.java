...
public class ImageUtils {
	...
	/**
	 * 暂不用//// 获取字符长度，一个汉字作为 1 个字符, 一个英文字母作为 0.5 个字符
	 * 
	 * @param text
	...
	public static void pressText(String targetImg, String pressText,
		...
		try {
			...
			g.drawString(pressText, width - width_1, height - height_1);
			g.dispose();
			ImageIO.write(bufferedImage, PICTRUE_FORMATE_JPG, file);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void main(String[] args) throws IOException {
		...
		pressText("/Users/chain/Downloads/caiwu.png", "@www.shiwtc.com", "宋体",
				Font.BOLD, 30, Color.RED, 0, 0, 1);
	}
