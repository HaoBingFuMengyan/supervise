 ...
 */
public class PageResult<T> extends ChunkEx<T> implements Page<T> {
	...
	/**
	 * Creates a new {@link PageResult} with the given content. This will result in the created {@link Page} being identical
	...
	public <S> Page<S> map(Converter<? super T, ? extends S> converter) {
		return new PageResult<S>(getConvertedContent(converter), pageable, total);
	}
