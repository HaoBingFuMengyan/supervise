...
public abstract class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	/**
	 * 由当前时间返回yyyy-mm格式的日期字符串
	 *
	 * @return String
	 */
	public static String yyyyMM(Date d) {
	...
	public static String getCurrentTimeNumberRandom() {
		return new SimpleDateFormat("yyyyMMddHHmmss")
				.format(new java.util.Date()) + new Random(100000).nextInt();
	}
	 ...
	 * @param month
	 *            月 1~12
	 * @return 月底的Date对象。例如：2006-3-01 00:00:00
	 */
     ...
     * @param minDate    开始日期
     * @param maxDate	  结束日期
     * @param maxDate    要返回的时间的格式，类似yyyy-MM
     * @return
