 ...
 * @since 1.8
 */
abstract class ChunkEx<T> implements Slice<T>, Serializable {
	...
	/**
	 * Creates a new {@link ChunkEx} with the given content and the given governing {@link Pageable}.
	 * 
	 * @param content must not be {@literal null}.
	 * @param pageable can be {@literal null}.
	 */
	public ChunkEx(List<T> content, Pageable pageable) {
	...
	/**
	 * Applies the given {@link Converter} to the content of the {@link ChunkEx}.
	 * 
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ChunkEx<?>)) {
			return false;
		}

		ChunkEx<?> that = (ChunkEx<?>) obj;
