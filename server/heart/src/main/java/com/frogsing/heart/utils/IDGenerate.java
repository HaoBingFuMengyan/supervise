 ...
 * Created by wesson on 2018/3/21.
 */
...
public class IDGenerate {
    ...
    public static IDGenerate idGenerate = null;
    static {
        idGenerate = new IDGenerate(0);
    }
     ...
     */
    public IDGenerate(long workerId) {
    ...
    public static void main(String[] args)  {
        IDGenerate idWorker = new IDGenerate(1020);
