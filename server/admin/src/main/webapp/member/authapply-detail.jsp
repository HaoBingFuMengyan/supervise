        ...
        <div class="layui-colla-content layui-show">
            <div class="layui-info">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label">信息变更：</label>
                        <div class="layui-input-inline">
                ...
                <c:if test="${(data.istatus eq 1 && operator.ioperatortype eq 10) || isAdmin eq 1}">
                    <div class="layui-form-item">
                        <div class="layui-inline">
...
<c:if test="${data.bisincompany eq 1 || isAdmin eq 1 || (data.istatus eq 1 && (operator.ioperatortype eq 10 || operator.ioperatortype eq 40) && (data.iprocess eq 10 || data.iprocess eq 20 || data.iprocess eq 30 || data.iprocess eq 40))}">
