		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<form id="inputForm"  action="${ctx}/dt/layoutdetail/newssave.shtml"  method="post" class="form-horizontal form-group" >
						...
						<div class="control-group">
							<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
								...
								<tr>
									<td class="active width-15"><label class="pull-right">关联新闻:<font color="red">*</font></label></td>
									<td colspan="3"><sys:treeselect id="menu" name="srelaseid" value="${lyd.srelaseid}"
                                                                 labelName="parent.sname"
                                                                 labelValue="${lyd.sdetailname}"
                                                                 title="菜单" url="/dt/navigation/treeData.shtml" extId="${lyd.srelaseid}"
                                                                 cssClass="form-control required"/></td>
									<%-- <td class="active width-15"><label class="pull-right">关联编号:<font color="red">*</font></label></td>
									<td><input name="srelasecode" value="${lyd.srelasecode}" readonly="readonly"  maxlength="20" class="form-control required"  /></td> --%>
								...
								<%-- <tr>
									...
									<td ><input name="surl" value="${lyd.bisoutlink }"  maxlength="20" class="form-control"/></td>
								</tr> --%>
								<tr>
