...
//            }}
            ,{field:'fsaleamount', title: '采购总额(元)',width:120,sort: true,align:'right',templet:function (d) {
                return d.fsaleamount;
            }}
...
//            ,{field:'fsaleamount', title: '销售金额(元)',width:120,sort: true,align:'right'}
        ...
        jj.shure=function (obj) {
            ...
            layer.confirm('您确定要确认此项目吗？', {
                ...
                jj.post("${ctx}/projectstock/buyer-shure.json",{id:projectid});
            }, function(){
                jj.closeAll();
            });
        };
        ...
        jj.detail=function(d){
            layer.open({
                ...
                title:"查看项目详情",
                area: ['80%', '80%'],
                content:"${ctx}/project/index.shtml?roleType=down&id="+d.id,
                btn: ['关闭'],
