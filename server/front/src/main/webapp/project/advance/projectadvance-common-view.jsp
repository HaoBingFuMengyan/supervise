            ...
            <div class="layui-info">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <em><mw:format label='percent' value='${p.fbondrate}'/></em>&nbsp;%
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label  class="layui-form-label">预付款比例： </label>
                        <div class="layui-input-inline">
                            <em><mw:format label='percent' value='${p.fadvancerate}'/></em>&nbsp;%
                        </div>
                    </div>
                    <div class="layui-inline">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <em><mw:format label='money' value='${p.fbondamount}'/></em>&nbsp;元
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label  class="layui-form-label">预付款金额： </label>
                        <div class="layui-input-inline">
                            <em><mw:format label='money' value='${p.fadvanceamount}'/></em>&nbsp;元
                        </div>
                    </div>

                    <div class="layui-inline">
                        <label  class="layui-form-label">是否控货： </label>
                        <div class="layui-input-inline">
                            <input type="checkbox" title="控货" lay-filter="switchTest" readonly="readonly" <c:if test="${p.bislimit == 1}">checked</c:if>>
                        </div>
                    </div>
                    <%--<div class="layui-inline">--%>
...
<table class="layui-table" lay-size="sm" lay-filter="detail">
    ...
    <c:forEach items="${p.detailsList}" var="sin" varStatus="ind">
        <tr>
            ...
            <td>${sin.finwegith}</td>
            <td><mw:format label="weight2" value="${map[sin.id].fcanuse}" format="#"/></td>
