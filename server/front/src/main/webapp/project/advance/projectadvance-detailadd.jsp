...
//                        indentureRows += "<td class=\"tc\">" + shostname + "、" + shostmodel + "、" + shostbrand + "</td>";
                        indentureRows += "<td class=\"tc\">" + fmt(getRoundValue(parseFloat(fweight), 4) * 1, "#,##0.0000") + "</td>";
                        ...
                        if (isNull(sid))
                            ...
                            indentureRows += "<td class=\"tc\"><a  href=\"javascript:void(-1)\" onclick=\"doEditDetail('" + num + "');\">编辑</a>&nbsp;|&nbsp;<a onclick=\"javascript:deletedetail('" + num + "')\" href=\"javascript:void(-1)\" data-flag='remove'>删除</a></td>";
                        //indentureRows+="</tr>";
...
<form action="" method="post" id="formx" class="layui-form">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-form-mid layui-word-aux xunit"></div>
        </div>
        <div class="layui-inline">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="fsaleprice" type="text" name="fsaleprice" value="" placeholder="(必填项)"
                       class="layui-input required money gt0" autocomplete="off"/>
            </div>
            <div class="layui-form-mid layui-word-aux">元</div>
        </div>
