        ...
        $().ready(function () {
            ...
            jj.validate("#formx",{
                submitHandler: function(form){
                    ...
                    if(fbuyprice==0||fsaleprice==0||fproxyprice==0){
                        layer.msg("价格不能为0")
                        return false;
                    }
...
//                        indentureRows += "<td class=\"tc\">" + shostname + "、" + shostmodel + "、" + shostbrand + "</td>";
                        ...
                        indentureRows += "<td class=\"tc\">" + sremark + "</td>";//代理单价
                        if (isNull(sid))
                            indentureRows += "<td class=\"tc\"><a  href=\"javascript:void(-1)\" class=\"layui-abtn\" onclick=\"doEditDetail('" + num + "');\">编辑</a><a  class=\"layui-abtn\" href=\"javascript:void(-1)\" data-flag='remove'>删除</a></td>";
                        else
                            indentureRows += "<td class=\"tc\"><a  href=\"javascript:void(-1)\" class=\"layui-abtn\" onclick=\"doEditDetail('" + num + "');\">编辑</a><a class=\"layui-abtn\" onclick=\"javascript:deletedetail('" + num + "')\" href=\"javascript:void(-1)\" data-flag='remove'>删除</a></td>";
                        //indentureRows+="</tr>";
...
<form action="" method="post" id="formx" class="layui-form">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" id="fweight" name="fweight"
                       value="<mw:format label="weight" value='' format='###.###'/>" placeholder="(必填项)" required
                       class="layui-input required  gt0"  autocomplete="off"/>
            </div>
            <div class="layui-form-mid layui-word-aux xunit">(单位：)</div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">采购单价</label>
            <div class="layui-input-inline">
                <input type="text" id="fbuyprice" name="fbuyprice" value="" placeholder="(必填项)"
                       class="layui-input required money gt0" autocomplete="off"/>
            </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="fsaleprice" type="text" name="fsaleprice" value="" placeholder="(必填项)" class="layui-input required money gt0" autocomplete="off"/>
            </div>
            <div class="layui-form-mid layui-word-aux">元</div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" id="fproxyprice" name="fproxyprice"
                       value="" placeholder="(必填项)" class="layui-input required money gt0" autocomplete="off"/>
            </div>
            <div class="layui-form-mid layui-word-aux">元</div>
        </div>
    </div>
