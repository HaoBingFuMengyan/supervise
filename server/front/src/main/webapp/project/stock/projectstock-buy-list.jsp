...
<form id="searchForm" class="layui-form">
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" id="sellname" name="search_like_ssalename" placeholder="" autocomplete="off"
					   class="layui-input"/>
			</div>
		</div>
		<div class="layui-inline">
...
//            ,{field:'floanamount', title: '融资金额(元)',width:120,sort: true,align:'right'}
        ...
        jj.detail=function(d){
            layer.open({
                ...
                title:"查看项目详情",
                area: ['80%', '80%'],
                content:"${ctx}/project/index.shtml?id="+d.id+"&roleType=down",
                btn: ['关闭'],
...
<script type="text/html" id="barDemo">
	<div class="layui-btn-group" data-rowid="{{d.id}}">
		...
		<jj:listbtn name="确认项目" event="shure" type="a" purview="projectstock:confirm"/>
		{{#  } }}

		{{#  if( (d.istatus==320 || d.istatus==330) &&d.ext.fcanuse>0 )  { }}
