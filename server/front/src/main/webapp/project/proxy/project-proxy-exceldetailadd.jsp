    ...
    <script type="text/javascript">
        ...
        layui.use(['layer', 'form','element','upload'], function () {
            ...
            upload.render({
                elem: '#excel'
                ,exts:'xls|xlsx'
                ,url: '${ctx}/projectproxy/readExcel.json'
...
<div class="mbody">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
        <legend>请选择Excel文件
            <input type="file" name="excel" id="excel">&nbsp;<a target="_blank" style="color: #1d74e0;text-decoration:underline;"href="<cs:SysParaType imgurl="1" op="syspara"/>/dinner/model/代理项目导入模板.xls">下载模版</a>
        </legend>
    </fieldset>
