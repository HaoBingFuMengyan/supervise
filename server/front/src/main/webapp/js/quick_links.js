jQuery(function($){
	...
	quickDataFns = {
		...
		message_list: {
			title: '购物车',
			content: '<div class="ibar_plugin_content"><div class="ibar_cart_group ibar_cart_product"><div class="ibar_cart_group_header"><!--<input class="mid" type="checkbox" />全选--><a href="${ctx}/cart/list.shtml">查看全屏</a></div><div class="ibar_cart_shop"><input class="mid" type="checkbox" />众鸣不锈钢店</div><ul><li class="cart_item clearfix"><div class="cart_item_pic"><a href="#"><img src="images/news3.png" /></a></div><div class="cart_item_desc"><a href="#" class="cart_item_name">原木-落叶松</a><div class="cart_item_sku"><span>俄标1级/4000*200*100mm</span><span>长度/宽度：2000/300mm</span></div><div class="cart_item_price"><span class="cart_price">￥700.00</span></div></div>	</li></ul></div><div class="cart_handler"><div class="cart_handler_header"><span class="cart_handler_left">共<span class="cart_price">1</span>件商品</span><span class="cart_handler_right">￥569.00</span></div><a href="#" class="cart_go_btn" target="_blank">去购物车结算</a></div></div>',
			init:$.noop
		},
		...
		mpbtn_histroy:{
			title: '我的足迹',
			content:'<div class="ibar_plugin_content"><div class="ibar-history-head">共3件产品<a href="#">清空</a></div><div class="ibar-moudle-product"><div class="imp_item"><a href="#" class="pic"><img src="images/news2.png"  /></a><p class="tit"><a href="#">板材-落叶松</a></p><p class="price"><em>￥</em>649.00</p><a href="#" class="imp-addCart">加入购物车</a></div><div class="imp_item"><a href="#" class="pic"><img src="images/news3.png" /></a><p class="tit"><a href="#">原木-落叶松</a></p><p class="price"><em>￥</em>649.00</p><a href="#" class="imp-addCart">加入购物车</a></div><div class="imp_item"><a href="#" class="pic"><img src="images/news1.png"/></a><p class="tit"><a href="#">板材-红木</a></p><p class="price"><em>￥</em>649.00</p><a href="#" class="imp-addCart">加入购物车</a></div></div></div>',
			init: $.noop
		},
		mpbtn_wdsc:{
			title: '收藏的产品',
			content: '<div class="ibar_plugin_content"><div class="ibar_cart_group ibar_cart_product"><ul><li class="cart_item clearfix"><div class="cart_item_pic"><a href="#"><img src="images/news2.png" /></a></div><div class="cart_item_desc"><a href="#" class="cart_item_name">板材-落叶松</a><div class="cart_item_sku"><span>俄标1级/4000*200*100mm</span><span>长度/宽度：2000/300mm</span></div><div class="cart_item_price"><span class="cart_price">￥700.00</span><a href="#" class="sc">删除</a></div></div>	</li></ul></div><div class="cart_handler"><a href="#" class="cart_go_btn jiaru" target="_blank">加入购物车</a></div></div>',
			init: $.noop
		},
		mpbtn_recharge:{
			title: '手机充值',
	...
	showQuickPop = function(type){
		...
		if(type !== prevPopType){
			var me=this;
            if(getTypeData){
                getTypeData(type,function(rs){
                    if(rs){
                        quickDataFns[type].content=rs;
                    }
