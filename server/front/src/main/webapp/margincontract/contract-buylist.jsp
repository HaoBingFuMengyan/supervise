...
<script>
    ...
    layui.use(['table','layer','laydate'],function(){
        ...
        jj.url="${ctx}/margincontract/buylist.json";
        ...
        jj.detail=function (obj) {
            layer.open({
                ...
                title:"合同详情",
                area: ['80%', '75%'],
                content: '${ctx}/margincontract/view_'+obj.id+'.shtml' ,
                btn: ['关闭'],
...
<script type="text/html" id="barDemo">
    ...
    <div class="layui-btn-group" data-rowid="{{d.id}}">
        <jj:listbtn name="查看" event="detail" type="a" purview="buymargincontract:query"/>
    </div>
</script>
</body>
</html>
