...
<div class="layui-collapse top10">
    <div class="layui-colla-item">
        <h2 class="layui-colla-title">合同编号：${marginContract.scontractsellerno}&nbsp;&nbsp;&nbsp;&nbsp;合同进度：<consts:ContractProgress val="${marginContract.iprogress }"/></h2>
            ...
            <div class="layui-info">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            ${marginContract.ssellermembername}
                        </div>
                    </div>
                    <%--<div class="layui-inline">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            ${jj:weight(marginContract.ftotalweight)}
                        </div>
                    </div>
                    <div class="layui-inline">
    ...
    <div class="layui-colla-item">
        <h2 class="layui-colla-title">合同明细</h2>
        <div class="layui-colla-content layui-show">
            <table class="layui-table" lay-size="sm" lay-filter="detail">
                ...
                <tr>
                    ...
                    <th lay-data="{field:'foutprice', width:130,align:'right'}">交收单价(元)</th>
                    <th lay-data="{field:'foutamount', width:130,totalRow:true,align:'right'}">交收金额(元)</th>
                </tr>
                </thead>
                <tbody>
                ...
                <c:forEach items="${marginContract.contractDetailList}" var="obj">
                    <tr>
                        ...
                        <td>${obj.sspec}</td>
                        <td>${obj.sproducer}</td>
                        <td>${jj:weight(obj.fweight)}&nbsp;${obj.sweightunit}</td>
