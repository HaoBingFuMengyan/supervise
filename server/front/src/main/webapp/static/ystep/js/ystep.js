	      ...
	      var baseHtml =  "<div class='ystep-container'>"+
	                        ...
	                        "<div class='ystep-progress'>"+
	                          "<p class='ystep-progress-bar'>"+
	                            "<span class='ystep-progress-highlight' style='height:0%'>"+
	                            "</span>"+
	                          "</p>"+
	                        "</div>"+
	                      "</div>";
	      ...
	      var logic = {
	        size: {
	          small: function($html){
	            ...
	            containerHeight = (stepCount*65+100)+"px",
	            progressHeight = (stepCount*65)+"px";
	            $html.css({
	          ...
	          large: function($html){
	            var stepCount = $html.find("li").length-1,
	            containerHeight = (stepCount*100+100)+"px",
	            progressHeight = (stepCount*100)+"px";
	            $html.css({
	              height: containerHeight
	            });
	            $html.find(".ystep-progress").css({
...
//初始化流程图
function initStep(id,sstepjson,istep){
  alert(id+":"+sstepjson+":"+istep);
