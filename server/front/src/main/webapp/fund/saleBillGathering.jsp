...
<body>
<%@include file="/fund/salebillpay-common-view.jsp"%>
<div class="layui-collapse top10">
    <div class="layui-colla-item">
        <h2 class="layui-colla-title">收款信息</h2>
        <div class="layui-colla-content layui-show">
            <form class="layui-form" action="${ctx}/fund/billpay/saleBillGathering.shtml" method="post" id="formx" enctype="multipart/form-data" novalidate="novalidate">

                <input type="hidden" name="id" id="id" value="${obj.id}"/>

                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">实际收款金额(元)</label>
                    <div class="layui-input-block">
                        ...
                        <a onclick="$('#fpayamount').val('${obj.famount}');" style="color: #1E9FFF;margin-left: 10px;cursor: pointer;">全额收款</a>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                ...
                <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                    <legend>收款附件<a id="addFile" class="layui-btn layui-btn-sm" style="margin-left: 20px;">添加附件</a><label id="doUploadFile"></label></legend>
                </fieldset>
