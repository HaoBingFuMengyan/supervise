...
<body>
<form class="layui-form" id="searchForm" action="${ctx}/zy/marginstock/marginonsale.json" method="post"
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">储存地点 </label>
        <div class="layui-input-block">
            <input type="text" id="sstorelocation" name="sstorelocation" autocomplete="off" class="layui-input required"
                   placeholder="请输入货物存放城市名称"/>
        </div>
    </div>
    <div class="layui-form-item">
