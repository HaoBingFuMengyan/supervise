    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#done0").click(function () {
                if($(".commit-con0 input").val()!='' && $(".commit-con0 textarea").val()!=''){
                    success ();
                }
                else {
                    layer.msg("请完善信息");
        ...
        <div class="right-extra">
            <div class="clearfix">
                <div id="preview" class="spec-preview left">
                    <span class="jqzoom"><img jqimg="${obj.sbigpic}" src="${obj.sbigpic}"/></span>
                </div>
                    ...
                    <div class="Pro_bot">
                        ...
                        <div class="Pro_inforjg">
                            ...
                            <div class="Pro_list">
                                <i>交货周期：</i>
                                <c:choose>
                                    <c:when test="${obj.igoodstype eq 0}">
                                        按单生产[生产周期${obj.ideliverydays}天]
                                    </c:when>
                                    <c:otherwise>
                                        ${obj.ideliverydays}天
                                    </c:otherwise>
                ...
                <div class="view-le left">
                    ...
                    <div class="Product_hot">
                        <c:forEach items="${list}" var="hotobj">
                            <a href="${ctx}/zy/marginstock/secequip_view.html?id=${hotobj.id}" target="_blank">
                                <div class="L_hot_list">
                                    <img src="${hotobj.sbigpic}">
