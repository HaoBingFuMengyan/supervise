...
<div class="mbody">
	<mw:msg/>
	<form class="layui-form" action="${ctx}/contract/approval.json" method="post" id="formx" onkeydown="if(event.keyCode==13) return false;"
			...
			<div class="layui-tab-content" style="height: 100%;">
				<div class="layui-tab-item layui-show">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" id="sname" name="sname" autocomplete="off" placeholder="请输入名称" value="“煤亮子”煤炭生产综合服务平台<c:choose><c:when test="${contract.icontracttype == 0}">采购</c:when><c:otherwise>销售</c:otherwise></c:choose>合同" readonly="readonly" class="layui-input" />
							</div>
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea placeholder="请输入资信简介" class="layui-textarea required" id="screditbrief" name="screditbrief"></textarea>
						</div>
					</div>
					<div class="layui-form-item layui-form-text">
