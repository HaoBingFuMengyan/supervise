...
<form  id="searchForm" class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="buymember" name="search_like_buymember.scnname" placeholder="" autocomplete="off" class="layui-input"/>
                    </div>
                </div>
                <div class="layui-inline">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <contract:BillStatus op="select" defname="全部" defval="" option="class='layui-input'" name="search_eq_ibillstatus" nshow="40,60"/>
                    </div>
                </div>
                <div class="layui-inline">
...
<script>
    ...
    layui.use(['table','layer','laydate'],function(){
        ...
        jj.url="${ctx}/ht/receiptInfo/list.json";

        jj.cols= [[
            {field:'scode', title: '单据编号',minWidth:150,sort: true}
            ,{field:'sbillno', title: '合同编号',minWidth:150,sort: true}
            ,{field:'sbuymemberid', title: '收票方',minWidth:200,sort: true,templet: function (d) {
                    return d.buymember.scnname;
                }}
            ...
            ,{field:'finvoiceamount', title: '开票金额',width:120,sort: true,align:'right'}
            ,{field:'dinvoicedate', title: '开票时间',width:180,sort: true,templet:function (d) {
        ...
        jj.detail=function (obj) {
            layer.open({
                ...
                title:"开票详情",
                area: ['85%', '65%'],
                content: '${ctx}/ht/receiptInfo/detail_'+obj.id+'.shtml?isCancle=false&op=kp',
                btn: ['关闭'],
        ...
        jj.cancleReceipt=function (obj) {
            layer.open({
                ...
                yes:function (index,layero) {
                    layer.confirm('确定要撤销开票吗？', {icon: 3, title:'系统提示'}, function(index){
        ...
        jj.shureReceipt=function (obj) {
            layer.open({
                ...
                title:"开票信息",
                area: ['85%', '65%'],
                content: '${ctx}/ht/receiptInfo/detail_'+obj.id+'.shtml?isCancle=false&itype=1&op=kp',
                btn: ['确认开票','关闭'],
                yes:function (index,layero) {
        ...
        jj.modifyReceipt=function (obj) {
            layer.open({
                ...
                title:"开票信息",
                area: ['85%', '65%'],
                content: '${ctx}/ht/receiptInfo/detail_'+obj.id+'.shtml?idetail=1&itype=1&op=kp',
                btn: ['确认修改','关闭'],
                yes:function(index,layero) {
...
<script type="text/html" id="barDemo">
    ...
    <div class="layui-btn-group" data-rowid="{{d.id}}">
        ...
        {{# if(d.ibillstatus == 30 && d.ibillstatus != 50 && d.ibillstatus != 10){ }}
            <jj:listbtn name="确认开票" event="shureReceipt" css="layui-abtn" type="a" purview=""/>

            <jj:listbtn name="修改" event="modifyReceipt" css="layui-abtn" type="a" purview=""/>

            <jj:listbtn name="撤销开票" event="cancleReceipt" css="layui-abtn" type="a" purview="ticket:cancel"/>
        {{#   } }}
    </div>
</script>
</body>
